...
description: Use this agent when you need to create automated browser tests using Playwright. Reads a test plan, executes each step live in the browser, then writes the generated TypeScript test file. Example usage — provide test-suite name, test name, output file path, seed file, and the test body steps.
